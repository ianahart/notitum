...
import com.hart.notitum.workspace.response.DeleteWorkspaceResponse;
...
public class WorkspaceController {
    ...
    public ResponseEntity<DeleteWorkspaceResponse> deleteWorkspace(@PathVariable("workspaceId") Long workspaceId, @RequestParam("userId") Long userId) {
